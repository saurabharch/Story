! function (e) {
    ...
    var ce, le, pe, fe, de, he, ye = function (e) {
                ...
                if ("error" === o.type && "error" === i.type) {
                    if ("mismatch" === o.errorType) {
                        if ("mismatch" === i.errorType) {
                            ...
                            return Fe(new me("Invalid value for " + r.label + ": " + (a === s ? a : a + " or " + s) + ". You specified " + (u === c ? u : u + " and " + c) + "."))
                        }
                        return Fe(i.error)
                    }
                    return Fe(o.error)
        ...
        He = function (e, t) {
            return function (n, r) {
                return n instanceof e ? Le(n) : De("a " + t + " instance", n, r)
            }
        },
        We = function (e, t) {
            return function (n, r) {
        ...
        Ke = function (e) {
            return function (t, n) {
                return "string" == typeof t && 0 === t.indexOf(e) ? Le(t) : De("a string starting with " + e, t, n)
            }
        },
        Ye = function () {
        ...
        Je = (Ye.apply(void 0, s(Object.keys(Re))), function (e, t) {
            return "string" == typeof e ? Le(e) : De("a string", e, t)
        }),
        Qe = function (e, t) {
            return function (n, r) {
        ...
        Ze = function (e, t) {
            return "boolean" == typeof e ? Le(e) : De("a boolean", e, t)
        },
        Xe = function (e, t) {
            return "number" == typeof e && e === parseInt(e, 10) ? Le(e) : De("an amount in the currency's subunit", e, t)
        },
        et = function (e, t) {
            return e && "object" === (void 0 === e ? "undefined" : Ne(e)) ? Le(e) : De("an object", e, t)
        },
        tt = function (e) {
            return function (t, n) {
                if (Array.isArray(t)) {
                        ...
                        if ("valid" === o.type)
                            for (var i = {}, a = 0; a < o.value.length; a += 1) {
                                ...
                                if ("object" === (void 0 === s ? "undefined" : Ne(s)) && s && "string" == typeof s[e]) {
                                    var u = s[e];
                                    if (i[u]) return Fe(new me("Duplicate value for " + e + ": " + u + ". The property '" + e + "' of '" + r.path.join(".") + "' has to be unique."));
                                    i[u] = !0
                                }
                            }
                        return o
        ...
        rt = function (e) {
            return function (t, n) {
                return void 0 === t ? Le(void 0) : De("used in " + e + " instead", t, n)
            }
        },
        ot = function (e) {
            return function (t) {
                return function (n, r) {
                    if (n && "object" === (void 0 === n ? "undefined" : Ne(n)) && !Array.isArray(n)) {
                        ...
                        if (i && e) return Fe(new me("Invalid " + r.label + " parameter: " + [].concat(s(r.path), [i]).join(".") + " is not an accepted parameter."));
                        var u = Le({});
        ...
        mt = function (e) {
            switch (e) {
                case "CARD_ELEMENT":
                    return yt("elements-inner-card-fc20db3564c5c0261f09814b4a08f1d9.html");
                case "CONTROLLER":
                    return yt("controller-3336a10cec1828e6c8870d5b19a3766f.html");
                case "METRICS_CONTROLLER":
                    return "https://js.stripe.com/v2/m/outer.html";
                case "PAYMENT_REQUEST_ELEMENT":
                    return yt("elements-inner-payment-request-e4a920cf8b95d075b2ab29caa5dd94a7.html");
                case "PAYMENT_REQUEST":
                    return yt("payment-request-inner-a6bb330f94a024ae4d8c5f1087ed8373.html");
                case "IBAN_ELEMENT":
                    return yt("elements-inner-iban-4925fb087a056a8a65fd9d2f21957d6e.html");
                case "IDEAL_BANK_ELEMENT":
                    return yt("elements-inner-ideal-bank-528ddd691dbf76c47cc45402b09e547f.html");
                case "AUTHORIZE_WITH_URL":
                    return yt("authorize-with-url-inner-86482450bafd2ce2cd71639089826b97.html");
                default:
                    return _e(e)
            }
        },
        ...
        Bn = ["button", "checkbox", "file", "hidden", "image", "submit", "radio", "reset"],
        Dn = function (e) {
            var t = e.tagName;
            if (e.isContentEditable || "TEXTAREA" === t) return !0;
            if ("INPUT" !== t) return !1;
            var n = e.getAttribute("type");
            return -1 === Bn.indexOf(n)
        },
        zn = Dn,
        Un = function (e) {
        ...
        Br = function (e) {
            ...
            return window.ApplePaySession.canMakePaymentsWithActiveCard(e).then(function (e) {
                return Fr && Fr("payreq.can_make_payment_native_response", {
                    available: e
                }), e
            })
        }),
        Dr = function (e, t, n, r) {
            if (Fr = r, window.ApplePaySession) {
                if (Lr()) {
        ...
        Gr = {
            ...
            shippingType: ze(Ye.apply(void 0, F(Object.keys($r))))
        },
        Jr = Hr({}, Gr, {
            displayItems: ze(tt(at(Kr))),
            shippingOptions: ze(nt("id")(tt(at(Yr)))),
        ...
        Zr = Hr({}, Vr, {
            status: Ye.apply(void 0, F(Object.keys(Qr)))
        }),
        Xr = Hr({}, Vr, {
            currency: ze(Ge)
        }),
        ...
        io = function (e, t) {
            ...
            return -1 !== oo.indexOf(e) ? ["amex"].concat(B(n)) : n
        },
        ao = function (e, t) {
        ...
        yo = (fe = {}, D(fe, Qr.success, 0), D(fe, Qr.fail, 1), D(fe, Qr.invalid_payer_name, 2), D(fe, Qr.invalid_shipping_address, 3), D(fe, Qr.invalid_payer_phone, 4), D(fe, Qr.invalid_payer_email, 4), fe),
        mo = (de = {}, D(de, $r.pickup, "storePickup"), D(de, $r.shipping, "shipping"), D(de, $r.delivery, "delivery"), de),
        _o = {
            total: function (e) {
                return po(e.total, e)
            },
        ...
        Fo = function (e) {
            function t(e, n, r, o, i, a, s, u) {
                ...
                Bo.call(c), c._controllerReport = e, c._controllerWarn = n, c._createApplePaySession = r, c._tokenizeWithData = o, c._createSourceWithData = i, c._showCalledByButtonElement = null, c._authentication = a, c._mids = s, c._report("payreq.options", {
                    options: u
                });
        ...
        Bo = function () {
            ...
            this.canMakePayment = Vt(function () {
                return null === e._cachedCanMakePayment ? Dr(window.location.hostname, e._authentication.stripeAccount, Ie(e._authentication.apiKey) === Re.test, e._report).then(function (t) {
        ...
        $o = {
            ...
            paymentRequest: ze(Ue(He(Do, "stripe.paymentRequest(...)"), He(Wo, "stripe.paymentRequest(...)"))),
        ...
        ci = si,
        li = function (e, t, n, r) {
            return window.ApplePaySession ? new Do(e.report, e.warn, e.action.createApplePaySession, e.action.tokenizeWithData, e.action.createSourceWithData, t, n, r) : new Wo(e, t, n, r)
        },
        pi = li,
        fi = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
        ...
        Ii = function (e, t) {
            if ("string" != typeof e) return De("a client_secret string", e, t);
            var n = Ri(e);
            return null === n ? De("a client secret of the form pi_${id}_secret_${secret}", e, t) : Le(n, [])
        },
        Mi = function (e, t) {
            ...
            return function (t, n) {
                if ("object" === (void 0 === t ? "undefined" : ji(t)) && null !== t) {
                    ...
                    if (null != r && "string" != typeof r) {
                        ...
                        return Be("string", void 0 === r ? "undefined" : ji(r), a)
                    }
                    if (null != o && "object" !== (void 0 === o ? "undefined" : ji(o))) {
                        var s = Ci({}, n, {
                            path: [].concat(ie(n.path), ["source_data"])
                        });
                        return Be("object", void 0 === o ? "undefined" : ji(o), s)
                    }
                    var u = Ci({}, n, {
                            path: [].concat(ie(n.path), ["source_data"])
                        }),
                ...
                return null === t ? Be("object", "null", n) : Be("object", void 0 === t ? "undefined" : ji(t), n)
            }
        },
        Ni = function (e) {
            return function (t, n) {
                ...
                if ("object" !== (void 0 === t ? "undefined" : ji(t))) return Be("object", void 0 === t ? "undefined" : ji(t), n);
                if (null === t) return Be("object", "null", n);
                if (e) {
                ...
                return t.payment_intent ? Fe(new me("The payment_intent parameter has been removed. To fix, move everything nested under the payment_intent parameter to the top-level object.")) : qi({})(t, n)
            }
        },
        xi = function (e) {
        ...
        aa = function (e) {
            return "object" === (void 0 === e ? "undefined" : oa(e)) && null !== e ? e : {}
        },
        sa = function (e, t) {
            return function (n, r) {
                var o = Di(n);
        ...
        ca = function (e) {
            if (!e || "object" !== (void 0 === e ? "undefined" : ua(e))) return null;
            var t = e.type,
                n = se(e, ["type"]);
            return {
        ...
        ya = null,
        ma = function () {
            return ya || (ya = new Ai), ya
        },
        _a = function () {
            function e(t, n) {
                var r = this;
                ue(this, e), va.call(this);
                var o = ut(ha, t || {}, "Stripe()"),
                    i = o.value,
                    a = o.warnings,
                    s = i.apiKey,
                    u = i.stripeAccount,
                ...
                }), this._ensureHTTPS(), this._ensureStripeHosted(n), this._attachPaymentIntentMethods(this._betas), this._attachPaymentPagesMethods(this._betas), this._warnIE9Deprecation()
            }
            return da(e, [{
    ...
    var va = function () {
            ...
            this.elements = Vt(function (t) {
                ...
                return p ? e._controller.action.createSourceWithData({
                    ...
                    sourceData: f,
                    mids: e._mids()
                }).then(la) : xt.reject(new me("Please provide a source type to createSource."))
                ...
                return n.warnings.forEach(function (t) {
                    return e._controller.warn(t)
                }), e._controller.action.retrieveSource(r).then(la)
        ...
        ba = _a,
        ga = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            return typeof e
        } : function (e) {
            return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
        },
        ...
        Sa = function (e, t) {
            return new ba(wa({
                apiKey: e
            }, t && "object" === (void 0 === t ? "undefined" : ga(t)) ? t : {}), Ea)
        };
    Sa.version = ba.version, window.Stripe && 2 === window.Stripe.version && !window.Stripe.StripeV3 ? window.Stripe.StripeV3 = Sa : window.Stripe ? window.console && console.warn("It looks like Stripe.js was loaded more than one time. Please only load it once per page.") : window.Stripe = Sa;
    t.default = Sa
}, function (e, t, n) {
    "use strict";
