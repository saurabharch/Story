...
function (t, e) {
    ...
    return function (t) {
            ...
            delegate(...t) {
                return {
                    to: (e, n) => {
                        ...
                        for (const o of t) {
                            const t = this._delegations.get(o);
                            t ? t.set(e, n) : this._delegations.set(o, new Map([
                                [e, n]
                            ]))
                        }
                    }
        ...
        var ro = function (t, e) {
            ...
            return e = io(void 0 === e ? t.length - 1 : no(e), 0),
                function () {
        ...
        function Ao(t) {
            vo in t || (Object.defineProperty(t, vo, {
                value: new Map
            }), Object.defineProperty(t, _o, {
                value: new Map
        ...
        class Mo {
            constructor(t = {}) {
                ...
                if (t.direction && "forward" != t.direction && "backward" != t.direction) throw new m.b("view-tree-walker-unknown-direction: Only `backward` and `forward` direction allowed.", {
        ...
        class Fo {
            ...
            static createAfter(t) {
                ...
                if (!t.parent) throw new m.b("view-position-after-root: You can not make position after root.", {
                    root: t
                });
            ...
            static createBefore(t) {
                ...
                if (!t.parent) throw new m.b("view-position-before-root: You can not make position before root.", {
                    root: t
                });
        ...
        class Bo {
            ...
            setTo(t, e, n) {
                ...
                else if (t instanceof Bo || t instanceof Lo) this._setRanges(t.getRanges(), t.isBackward), this._setFakeOptions({
                    fake: t.isFake,
            ...
            _pushRange(t) {
                for (const e of this._ranges)
                    if (t.isIntersecting(e)) throw new m.b("view-selection-range-intersects: Trying to add a range that intersects with another range from selection.", {
                        addedRange: t,
                        intersectingRange: e
                    });
        ...
        class zo {
            constructor() {
                this.selection = new Lo, this.roots = new jo({
                    idProperty: "rootName"
        ...
        function Zo(t) {
            let e;
            if ("string" == typeof t) {
                if (!(e = Xo[t.toLowerCase()])) throw new m.b("keyboard-unknown-key: Unknown key name.", {
                    key: t
                })
        ...
        class si {
            ...
            remove(t) {
                ...
                } = this._breakAttributesRange(t, !0), o = e.parent, i = n.offset - e.offset, r = o._removeChildren(e.offset, i);
            ...
            _getTouchingInlineDomNode(t, e) {
                ...
                const n = e ? "nextNode" : "previousNode",
                    ...
                    r = o.createTreeWalker(i, NodeFilter.SHOW_TEXT | NodeFilter.SHOW_ELEMENT, {
                        acceptNode: t => Pi(t) ? NodeFilter.FILTER_ACCEPT : "BR" == t.tagName ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP
                    });
                r.currentNode = t;
                const s = r[n]();
                if (null !== s) {
        ...
        class Jr {
            constructor(t) {
                ...
                if (Object.defineProperty(this, "_source", {
                    ...
                    n.ownerDocument && n.ownerDocument.body.contains(n) || Ur.a.warn("rect-source-not-in-dom: The source of this rect does not belong to any rendered DOM tree.", {
                        source: t
            ...
            static getDomRangeRects(t) {
                ...
                if (n.length)
                    for (const t of n) e.push(new Jr(t));
                else {
        ...
        class ps {
            ...
            _insertNodes(t, e) {
                for (const t of e)
                    if (!(t instanceof us)) throw new m.b("model-nodelist-insertNodes-not-node: Trying to insert an object which is not a Node instance.");
        ...
        class gs {
            constructor(t = {}) {
                ...
                if ("forward" != e && "backward" != e) throw new m.b("model-tree-walker-unknown-direction: Only `backward` and `forward` direction allowed.", {
                    direction: e
                });
        ...
        class vs {
            constructor(t, e) {
                ...
                if (!(e instanceof Array) || 0 === e.length) throw new m.b("model-position-path-incorrect: Position path must be an array with at least one item.", {
                    path: e
                });
            ...
            static createAfter(t) {
                if (!t.parent) throw new m.b("model-position-after-root: You cannot make a position after root.", {
                    root: t
                });
                return this.createFromParentAndOffset(t.parent, t.endOffset)
            }
            static createBefore(t) {
                if (!t.parent) throw new m.b("model-position-before-root: You cannot make a position before root.", {
                    root: t
                });
            ...
            static fromJSON(t, e) {
                ...
                if (!e.getRoot(t.root)) throw new m.b("model-position-fromjson-no-root: Cannot create position for document. Root with specified name does not exist.", {
                    rootName: t.root
                });
            ...
            convertInsert(t, e) {
                ...
                for (const e of t) {
                    const t = e.item,
                        n = {
                            item: t,
                            range: _s.createFromPositionAndShift(e.previousPosition, e.length)
                        };
        ...
        class Ts {
            ...
            setFocus(t, e) {
                ...
                if ("same" == n.compareWith(this.focus)) return;
                const o = this.anchor;
                this._ranges.length && this._popRange(), "before" == n.compareWith(o) ? (this._pushRange(new _s(n, o)), this._lastRangeBackward = !0) : (this._pushRange(new _s(o, n)), this._lastRangeBackward = !1), this.fire("change:range", {
                    directChange: !0
                })
            }
            getAttribute(t) {
            ...
            _checkRange(t) {
                for (let e = 0; e < this._ranges.length; e++)
                    if (t.isIntersecting(this._ranges[e])) throw new m.b("model-selection-range-intersects: Trying to add a range that intersects with another range from selection.", {
                        addedRange: t,
        ...
        class Is extends Ts {
            constructor(t) {
                super(), this._model = t.model, this._document = t, this._attributePriority = new Map, this._fixGraveyardRangesData = [], this._hasChangedRange = !1, this._overriddenGravityRegister = new Set, this.on("change:range", () => {
                    for (const t of this.getRanges())
                        if (!this._document._validateSelectionRange(t)) throw new m.b("document-selection-wrong-position: Range from document selection starts or ends at incorrect position.", {
                            range: t
                        })
            ...
            restoreGravity(t) {
                if (!this._overriddenGravityRegister.has(t)) throw new m.b("document-selection-gravity-wrong-restore: Attempting to restore the selection gravity for an unknown UID.", {
                    uid: t
                });
        ...
        function Ns(t) {
            ...
            if (t.model.name && (e += ":" + t.model.name), t.model.values)
                for (const e of t.model.values) t.view[e] = Bs(t.view[e], "attribute");
        ...
        function Bs(t, e) {
            return "function" == typeof t ? t : (n, o) => (function (t, e, n) {
                ...
                if ("container" == n) o = e.createContainerElement(t.name, i);
                    ...
                    const n = {
                        priority: t.priority || Uo.DEFAULT_PRIORITY
                    };
        ...
        class zs {
            constructor(t) {
                this.model = t, this.view = new ls, this.mapper = new ks, this.downcastDispatcher = new As({
                    mapper: this.mapper
                });
            ...
            load(t, e = []) {
                ...
                function l(t) {
                    if (!a.includes(t) && !n.get(t) && !i.has(t)) return function (t) {
                        ...
                        throw Ur.a.error("plugincollection-load: It was not possible to load the plugin.", {
                            plugin: t
                        }), e
                    })
                }
        ...
        class Us {
            ...
            execute(t, ...e) {
                const n = this.get(t);
                if (!n) throw new m.b("commandcollection-command-not-found: Command does not exist.", {
                    commandName: t
                });
                n.execute(...e)
            }* names() {
        ...
        class Gs {
            ...
            register(t, e) {
                if (this._sourceDefinitions[t]) throw new m.b("schema-cannot-register-item-twice: A single item cannot be registered twice in the schema.", {
                    itemName: t
                });
                this._sourceDefinitions[t] = [Object.assign({}, e)], this._clearCache()
            }
            extend(t, e) {
                if (!this._sourceDefinitions[t]) throw new m.b("schema-cannot-extend-missing-item: Cannot extend an item which was not registered yet.", {
                    itemName: t
                });
        ...
        class Js {
            constructor(t) {
                ...
                "string" == typeof t ? t = [t] : Array.isArray(t) || (t = t.getAncestors({
                    includeSelf: !0
                })), t[0] && "string" != typeof t[0] && t[0].is("documentFragment") && t.shift(), this._items = t.map(ra)
            }
            get length() {
                return this._items.length
            }
        ...
        function Qs(t, e) {
            ...
            return function (t, e) {
                ...
                }(t, n), oa(t, n, "allowIn"), oa(t, n, "allowContentOf"), oa(t, n, "allowWhere"), oa(t, n, "allowAttributes"), oa(t, n, "allowAttributesOf"), oa(t, n, "inheritTypesFrom"),
                function (t, e) {
                    for (const n of t) {
        ...
        class fa {
            constructor(t, e) {
                this.model = t, this.processor = e, this.mapper = new ks, this.downcastDispatcher = new As({
                    mapper: this.mapper
        ...
        class pa {
            ...
            elementToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of ma(t)) this.for("upcast").add(aa({
                    model: e,
                    view: n,
            ...
            attributeToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of ma(t)) this.for("upcast").add(ca({
                    view: n,
                    model: e,
                    priority: t.priority
                }))
            ...
            attributeToAttribute(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of ma(t)) this.for("upcast").add(la({
                    view: n,
                    model: e
                }))
            }
        ...
        class Fa extends ba {
            ...
            static fromJSON(t, e) {
                if (!e.getRoot(t.root)) throw new m.b("rootattribute-operation-fromjson-no-root: Cannot create RootAttributeOperation. Root with specified name does not exist.", {
                    rootName: t
                });
        ...
        class Ba {
            static fromJSON(t, e) {
                if (!Da.has(t.__className)) throw new m.b("delta-fromjson-no-deserializer: This delta has no defined deserializer", {
                    name: t.__className
                });
        ...
        var $l = function (t, e, n, o) {
            ...
            for (n && (a = pc(t, mc(n))); ++r < s;)
                for (var c = 0, l = e[r], d = n ? n(l) : l;
                    (c = i(a, d, c, o)) > -1;) a !== t && Hl.call(a, c, 1), Hl.call(t, c, 1);
            return t
        };
        var Kl = function (t, e) {
        ...
        const Zd = new Map,
            tu = {
                ...
                transformDeltaSets(t, e, n = null) {
                    ...
                    const a = nu(o) - nu(t),
                        c = nu(i) - nu(e);
                    return c < a ? ou(i, a - c) : a < c && ou(o, c - a), {
                        deltasA: o,
                        deltasB: i
                    }
                }
        ...
        class bu {
            ...
            split(t, e) {
                ...
                if (e || (e = i.parent), !t.parent.getAncestors({
                        includeSelf: !0
                    }).includes(e)) throw new m.b("writer-split-invalid-limit-element: Limit element is not a position ancestor.");
                do {
                    const e = new za;
                    this.batch.addDelta(e);
            ...
            setSelectionAttribute(t, e) {
                if (this._assertWriterUsedCorrectly(), "string" == typeof t) this._setSelectionAttribute(t, e);
                    ...
                    for (const [e, n] of ds(t)) this._setSelectionAttribute(e, n)
            }
        ...
        class Ru {
            constructor(t) {
                this.model = t, this.version = 0, this.history = new Su(this), this.selection = new Rs(this), this.roots = new jo({
                    idProperty: "rootName"
                }), this.differ = new xu(t.markers), this._postFixers = new Set, this.createRoot("$root", Ou), this.listenTo(t, "applyOperation", (t, e) => {
                    const n = e[0];
                    if (n.isDocumentOperation && n.baseVersion !== this.version) throw new m.b("model-document-applyOperation-wrong-version: Only operations with matching versions can be applied.", {
                        operation: n
                    })
                }, {
                    priority: "highest"
            ...
            createRoot(t = "$root", e = "main") {
                if (this.roots.get(e)) throw new m.b("model-document-createRoot-name-exists: Root with specified name already exists.", {
                    name: e
                });
        ...
        function Du(t, e, n = {}) {
            ...
            t.change(t => {
                ...
                i.start.isTouching(i.end) || t.remove(i), n.leaveUnmerged || (! function t(e, n, o) {
                        ...
                        t(e, n, o)
                    }(t, r, s), o.removeDisallowedAttributes(r.parent.getChildren(), t)), e instanceof Rs ? t.setSelection(r) : e.setTo(r),
                    function (t, e) {
        ...
        class Yu {
            constructor(t) {
                ...
                this.config = new p(t, this.constructor.defaultConfig), this.config.define("plugins", e), this.plugins = new qs(this, e), this.commands = new Us, this.locale = new Hs(this.config.get("language")), this.t = this.locale.t, this.set("state", "initializing"), this.once("ready", () => this.state = "ready", {
                    priority: "high"
                }), this.once("destroy", () => this.state = "destroyed", {
                    priority: "high"
                }), this.set("isReadOnly", !1), this.model = new Gu, this.data = new fa(this.model), this.editing = new zs(this.model), this.editing.view.document.bind("isReadOnly").to(this), this.conversion = new pa, this.conversion.register("downcast", [this.editing.downcastDispatcher, this.data.downcastDispatcher]), this.conversion.register("editingDowncast", [this.editing.downcastDispatcher]), this.conversion.register("dataDowncast", [this.data.downcastDispatcher]), this.conversion.register("upcast", [this.data.upcastDispatcher]), this.keystrokes = new Qu(this), this.keystrokes.listenTo(this.editing.view.document)
            }
            initPlugins() {
                const t = this,
                    e = this.config;
        ...
        class eh {
            constructor() {
                this._domParser = new DOMParser, this._domConverter = new zi({
                    blockFiller: bi
        ...
        class nh {
            ...
            add(t, e) {
                if (this.has(t)) throw new m.b("componentfactory-item-exists: The item already exists in the component factory.", {
                    name: t
                });
                this._components.set(oh(t), {
                    callback: e,
                    originalName: t
                })
            }
            create(t) {
                if (!this.has(t)) throw new m.b("componentfactory-item-missing: The required component is not registered in the factory.", {
                    name: t
                });
        ...
        class sh extends rh {
            ...
            init() {
                ...
                e.editable.bind("isReadOnly").to(n), e.editable.bind("isFocused").to(t.editing.view.document), e.editable.name = n.rootName, this.focusTracker.add(this.view.editableElement), this.view.toolbar.fillFromConfig(this._toolbarConfig.items, this.componentFactory),
                    function ({
                        origin: t,
        ...
        class dh {
            ...
            revert(t) {
                ...
                yield* function* t(e) {
                    if (e.children)
                        for (const n of e.children) Ah(n) ? yield n: Ch(n) && (yield* t(n))
                }(this)
            }
            static bind(t, e) {
                return {
            ...
            _renderAttributes(t) {
                ...
                for (e in this.attributes)
                    if (o = r.getAttribute(e), n = this.attributes[e], s && (s.attributes[e] = o), i = W(n[0]) && n[0].ns ? n[0].ns : null, ph(n)) {
                        ...
                        s && Sh(e) && a.unshift(o), this._bindToObservable({
                            schema: a,
                            updater: gh(r, e, i),
                            data: t
                        })
            ...
            if ("string" == typeof t ? t = function (t) {
                ...
                if (t.children)
                    if (Th(t.children)) e.push(t.children);
                        ...
                        for (const n of t.children) Ch(n) || Ah(n) || Oi(n) ? e.push(n) : e.push(new dh(n));
                t.children = e
            }
            return t
        }
        ...
        class jh extends Eh {
            constructor(t) {
                ...
                this.items = this.createCollection(), this.focusTracker = new ih, this.keystrokes = new Ju, this.set("isVertical", !1), this.set("className"), this._focusCycler = new Dh({
                    ...
                    tag: "div",
                    attributes: {
                        class: ["ck", "ck-toolbar", e.if("isVertical", "ck-toolbar_vertical"), e.to("className")]
                    },
                    children: this.items,
                    on: {
            ...
            fillFromConfig(t, e) {
                t.map(t => {
                    "|" == t ? this.items.add(new Lh) : e.has(t) ? this.items.add(e.create(t)) : Ur.a.warn("toolbarview-item-unavailable: The requested toolbar item is unavailable.", {
                        name: t
                    })
                })
            }
        ...
        class Uh extends Yu {
            constructor(t, e) {
                super(e), ji(t) && (this.sourceElement = t), this._elementReplacer = new qh, this.data.processor = new eh, this.model.document.createRoot(), this.ui = new sh(this, new zh(this.locale)),
                    function (t) {
        ...
        class $h extends Vr {
            ...
            onDomEvent(t) {
                const e = {
                    dataTransfer: new Hh(t.clipboardData ? t.clipboardData : t.dataTransfer)
                };
        ...
        class Jh {
            constructor(t) {
                this.editor = t, this.set("value", void 0), this.set("isEnabled", !1), this.decorate("execute"), this.listenTo(this.editor.model.document, "change", () => {
                    ...
                    n ? (this.on("set:isEnabled", Qh, {
                        priority: "highest"
                    }), this.isEnabled = !1) : (this.off("set:isEnabled", Qh), this.refresh())
                })
            }
            refresh() {
                this.isEnabled = !0
            ...
            constructor(t) {
                ...
                e.on("keydown", (t, n) => {
                    if (this.isEnabled && n.keyCode == Xo.enter) {
                        ...
                        e.once("enter", t => o = t, {
                            priority: "highest"
                        }), e.fire("enter", new Fr(e, n.domEvent, {
                            isSoft: n.shiftKey
        ...
        function df(t) {
            ...
            for (const e of t)
                if ("children" === e.type && !uf(e)) return !0;
            return !1
        }
            ...
            constructor(t) {
                ...
                e.on("keyup", (t, e) => {
                    ...
                    i.unit = r ? "word" : i.unit, i.sequence = ++n, e.once("delete", t => s = t, {
                        priority: "highest"
                    }), e.fire("delete", new Fr(e, o.domEvent, i)), s && s.stop.called && t.stop()
                })
            }
            observe() {}
        }
        ...
        class Df extends Wh {
            ...
            init() {
                this.set("hasAny", !1), this._actions = new jo({
                    idProperty: "_id"
        ...
        class Ep {
            ...
            add(t, e) {
                ...
                const i = n[0];
                o === i || Pp(o, i) || this.fire("change:top", {
                    oldDescriptor: o,
                    newDescriptor: i,
                    writer: e
                })
        ...
        class Jp extends Wh {
            ...
            init() {
                ...
                this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (t, e, n) => {
                    ...
                    priority: "low"
                }), t.addObserver(Kp), this.listenTo(e, "mousedown", (...t) => this._onMousedown(...t)), this.listenTo(e, "keydown", (...t) => this._onKeydown(...t), {
                    priority: "high"
        ...
        class sm extends Eh {
            ...
            render() {
                super.render(), this.keystrokes.listenTo(this.element), em({
                    view: this
        ...
        um.arrowHorizontalOffset = 25, um.arrowVerticalOffset = 10, um._getOptimalPosition = function ({
            element: t,
            target: e,
            positions: n,
            limiter: o,
        ...
        class qm extends Wh {
            ...
            init() {
                ...
                }), t.commands.add("imageUpload", new jm(t)), this.listenTo(t.editing.view.document, "clipboardInput", (n, i) => {
                    if (function (t) {
        ...
        class $m extends Wh {
            ...
            init() {
                const t = this.editor,
                    e = t.model,
                    n = t.data;
                t.commands.add("paragraph", new Wm(t)), e.schema.register("paragraph", {
                    ...
                    if (n.consumable.test(e.viewItem, {
                        ...
                        if ($m.paragraphLikeElements.has(e.viewItem.name)) {
                            ...
                            const {
                                modelRange: i
                            } = n.convertChildren(e.viewItem, vs.createAt(t));
                    ...
                    priority: "lowest"
                }), e.document.registerPostFixer(t => this._autoparagraphEmptyRoots(t)), t.on("dataReady", () => {
        ...
        class Xm extends Wh {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = [];
                for (const o of e) o.model !== Ym && (t.model.schema.register(o.model, {
                    inheritAllFrom: "$block"
        ...
        class tg extends Eh {
            constructor(t) {
                ...
                this.set("isVisible", !1), this.children = this.createCollection(), this.setTemplate({
                    tag: "div",
                    attributes: {
                        class: ["ck", "ck-reset", "ck-dropdown__panel", e.if("isVisible", "ck-dropdown__panel-visible")]
                    },
                    children: this.children,
                    on: {
        ...
        class eg extends Eh {
            constructor(t, e, n) {
                ...
                this.buttonView = e, this.panelView = n, this.set("isOpen", !1), this.set("isEnabled", !0), this.focusTracker = new ih, this.keystrokes = new Ju, this.setTemplate({
                    tag: "div",
                    attributes: {
                        class: ["ck", "ck-dropdown", o.if("isEnabled", "ck-disabled", t => !t)]
                    },
                    children: [e, n]
                }), e.extendTemplate({
                    attributes: {
        ...
        class ig extends Of {
            ...
            _createArrowView() {
                const t = new Ef;
                return t.content = og.a, t.extendTemplate({
                    attributes: {
        ...
        function lg(t, e = ig) {
            const n = new e(t),
                o = new tg(t),
                i = new eg(t, n, o);
            return n.bind("isEnabled").to(i), n instanceof ig ? n.bind("isOn").to(i, "isOpen") : n.arrowView.bind("isOn").to(i, "isOpen"),
                function (t) {
                    (function (t) {
                        t.on("render", () => {
                            Xp({
        ...
        function mg(t, e) {
            return n => {
                ...
                return n.setCustomProperty(pg, !0, o), hg(t, o, e),
                    function (t, e) {
        ...
        class wg extends Wh {
            init() {
                ...
                const s = mg(e, r("h"));
                i.downcastDispatcher.on("insert:caption", vg(s)), i.downcastDispatcher.on("insert", this._fixCaptionVisibility(t => t.item), {
                    priority: "high"
        ...
        function Ng(t) {
            if ("string" == typeof t) {
                const e = t;
                Mg[e] ? t = Object.assign({}, Mg[e]) : (Ur.a.warn("image-style-not-found: There is no such image style of given name.", {
                    name: e
                }), t = {
                    name: e
                })
        ...
        class nb extends Wh {
            init() {
                ...
                t.model.schema.extend("$text", {
                    ...
                    }), t.conversion.for("dataDowncast").add(Ns({
                        model: "linkHref",
                        view: Kg
                    ...
                    })), t.commands.add("link", new qg(t)), t.commands.add("unlink", new Ug(t)),
                    function (t, e, n, o) {
        ...
        class Db extends Wh {
            ...
            init() {
                ...
                })(t.model, e)), n.mapper.registerViewToModelLength("li", Bb), e.mapper.registerViewToModelLength("li", Bb), n.mapper.on("modelToViewPosition", Pb), n.mapper.on("viewToModelPosition", Ob), e.mapper.on("modelToViewPosition", Pb), n.downcastDispatcher.on("insert", Ab, {
                    priority: "high"
                }), n.downcastDispatcher.on("insert:listItem", _b), e.downcastDispatcher.on("insert", Ab, {
                    priority: "high"
                }), e.downcastDispatcher.on("insert:listItem", _b), n.downcastDispatcher.on("attribute:listType:listItem", yb), e.downcastDispatcher.on("attribute:listType:listItem", yb), n.downcastDispatcher.on("attribute:listIndent:listItem", xb), e.downcastDispatcher.on("attribute:listIndent:listItem", xb), n.downcastDispatcher.on("remove:listItem", kb), n.downcastDispatcher.on("remove", Cb, {
                    priority: "low"
                }), e.downcastDispatcher.on("remove:listItem", kb), e.downcastDispatcher.on("remove", Cb, {
                    priority: "low"
                }), e.upcastDispatcher.on("element:ul", Sb, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:ol", Sb, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", Eb, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", Tb), t.model.on("insertContent", Rb, {
                    priority: "high"
                }), t.commands.add("numberedList", new mb(t, "numbered")), t.commands.add("bulletedList", new mb(t, "bulleted")), t.commands.add("indentList", new wb(t, "forward")), t.commands.add("outdentList", new wb(t, "backward"));
